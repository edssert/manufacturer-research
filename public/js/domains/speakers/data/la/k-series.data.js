...
export const LA_K_SERIES = [
  {
    ...
    ampRaw: "LA12X(2/2)",
    img: "public/assets/img/speakers/la/official/k-series/k1/02-3dr-k1-3-4-horizontal-01.jpg",
    views: [
      {
        label: "K1 3 4 Horizontal 01",
        src: "public/assets/img/speakers/la/official/k-series/k1/02-3dr-k1-3-4-horizontal-01.jpg",
      },
      {
        label: "K1 3 4 Avant Catalogue 01",
        src: "public/assets/img/speakers/la/official/k-series/k1/01-3dr-k1-3-4-avant-catalogue-01.jpg",
      },
      {
        label: "8xK1+K1-BUMP 01",
        src: "public/assets/img/speakers/la/official/k-series/k1/03-3dr-8xk1-k1-bump-01.jpg",
      },
    ],
    ...
    relations: {
      ...
      accessoryIds: [
        ...
        "acc-la-k2-link",
        "acc-la-kara-downk1",
        "acc-la-k1-lasermount",
        "acc-la-laser-magplate",
        "acc-la-k1-chariot2",
        "acc-la-k1-chariotcov",
        "acc-la-k-bumpflight",
        "acc-la-k1-pla",
        "acc-la-k1-cov",
        "acc-la-tech-toolcase-ii",
        "acc-la-maintenance-toolcase",
        "acc-la-do",
      ],
    },
    watt: 1118,
    ...
    presets: {
      rows: [
        ...
        {
          config: "K1 + K1-SB (on top)",
          preset: "[K1] + [K1SB_X]",
          acoustic: "enhanced LF throw, down to 30 Hz",
          acousticShort: "enhanced throw, down to 30 Hz",
          ratio: "2 K1 : 1 K1-SB",
          minLine: "8 K1 + 4 K1-SB",
        },
        {
          config: "K1 + coupled K1-SB (beside/behind)",
          preset: "[K1] + [K1SB_60]",
          acoustic: "reinforced LF contour, LF rejection(side polarized or rear cardioid), down to 33 Hz",
          acousticShort: "side/rear cardioid, down to 33 Hz",
          ratio: "1 K1 : 1 subwoofer",
        },
        {
          config: "K1 + coupled K1-SB (behind, NC)",
          preset: "[K1] + [K1SB_100_NC]",
          acoustic: "reinforced LF contour, LF rejection(rear cardioid), down to 25 Hz",
          acousticShort: "rear cardioid, down to 25 Hz",
          ratio: "1 K1 : 1 subwoofer",
        },
        {
          config: "K1 + subwoofers (KS28/SB28)",
          preset: "[K1] + [xx28_60]",
          acoustic: "reinforced LF contour, down to 25 Hz",
          acousticShort: "reinforced contour, down to 25 Hz",
          ratio: "1 K1 : 1 subwoofer",
        },
        {
          config: "K1 + coupled CS1 (beside/behind)",
          preset: "[K1] + [CS1_60]",
          acoustic: "reinforced LF contour, LF rejection(rear cardioid), down to 25 Hz",
          acousticShort: "rear cardioid, down to 25 Hz",
          ratio: "2 K1 : 1 CS1",
        ...
        {
          config: "K1 + coupled CS1 (supercardioid)",
          preset: "[K1] + [CS1_60_S]",
          acoustic: "reinforced LF contour, supercardioid pattern, down to 25 Hz",
          acousticShort: "supercardioid, down to 25 Hz",
          ratio: "2 K1 : 1 CS1",
        },
        {
          config: "K1 + Kara II (downfill)",
          preset: "[K1] + [KARAIIDOWNK1]",
          acoustic: "35 Hz - 20 kHz, extends vertical coverage to closer audience",
          acousticShort: "35 Hz - 20 kHz, downfill",
          ratio: "up to 6 Kara II",
        },
        {
          config: "K1 + K2 (downfill)",
          preset: "[K1] + [K2 110]",
          acoustic: "35 Hz - 20 kHz, same horizontal coverage as K1 for optimal downfill",
          acousticShort: "35 Hz - 20 kHz, downfill",
        },
      ],
      ...
      ratioSource:
        "K1_OM_EN.pdf (K1 owner's manual EN version 4.0) p.35-45; preset_guide_EN.pdf p.49-50 (owner's manual EN v29.0)",
      ...
      delayDefaults: {
        rows: [
          ...
          {
            combo: "[K1] + [K1SB_X] + [CS1_60] / [CS1_60_S]",
            items: ["K1 = 7.5 ms", "K1-SB = 7.5 ms", "CS1 = 0 ms (−)"],
          },
        ],
      ...
      source:
        "preset_guide_EN.pdf p.49-50 (owner's manual EN v29.0); K1_OM_EN.pdf (owner's manual EN v4.0) p.16, 34-45",
    },
    ...
    mechanicalSafety: {
      ...
      flownRows: [
        { config: "flown", accessory: "K1-BUMP", safeLimit: "16", maxLimit: "24" },
        {
          config: "flown",
          accessory: "K1-BUMP",
          safeLimit: "14 K1 + 3 LA-RAK II AVB",
          maxLimit: "23 K1 + 4 LA-RAK II AVB",
        },
        { config: "flown with a downfill", accessory: "KARA-DOWNK1", safeLimit: "6 Kara II", maxLimit: "6 Kara II" },
      ],
      stackedRows: [{ config: "stacked", accessory: "K1-CHARIOT", safeLimit: "4", maxLimit: "4" }],
      warnings: [
  ...
  },
  {
    ...
    cov: {
      ...
      v: "10°",
      splayList: [0.25, 1, 2, 3, 4, 5, 7.5, 10],
    },
    freqs: [
      {
        db: "-3 dB",
    ...
    img: "public/assets/img/speakers/la/official/k-series/k2/02-3dr-k2-perspective-01.png",
    views: [
      {
        label: "K2 Perspective 01",
        src: "public/assets/img/speakers/la/official/k-series/k2/02-3dr-k2-perspective-01.png",
      },
      {
        label: "K2 3 4 Avant Catalogue 03",
        src: "public/assets/img/speakers/la/official/k-series/k2/01-3dr-k2-3-4-avant-catalogue-03.png",
      },
      {
        label: "K2 Detail Catalogue 01",
        src: "public/assets/img/speakers/la/official/k-series/k2/03-3dr-k2-detail-catalogue-01.png",
      },
      {
        label: "12xK2+K2-BUMP+K2-BAR 01",
        src: "public/assets/img/speakers/la/official/k-series/k2/04-3dr-12xk2-k2-bump-k2-bar-01.png",
      },
      {
        label: "4xK2+K2-CHARIOT+2xK2-JACK 01",
        src: "public/assets/img/speakers/la/official/k-series/k2/05-3dr-4xk2-k2-chariot-2xk2-jack-01.png",
      },
    ],
    ...
    presets: {
      rows: [
        {
          config: "K2 line source",
          preset: "[K2 xxx]",
          acoustic: "35 Hz - 20 kHz, adjustable horizontal directivity",
          acousticShort: "35 Hz - 20 kHz, adjustable directivity",
        },
        {
          config: "K2 + K1-SB (on top)",
          preset: "[K2 xxx] + [K1SB_X K2]",
          acoustic: "enhanced LF throw, down to 30 Hz",
          acousticShort: "enhanced throw, down to 30 Hz",
          ratio: "3 K2 : 1 K1-SB",
          minLine: "12 K2 + 4 K1-SB",
        },
        {
          config: "K2 + coupled K1-SB (beside/behind)",
          preset: "[K2 xxx] + [K1SB_60]",
          acoustic: "reinforced LF contour, LF rejection(side polarized or rear cardioid), down to 33 Hz",
          acousticShort: "side/rear cardioid, down to 33 Hz",
          ratio: "3 K2 : 2 subwoofers",
          minLine: "12 K2 + 8 K1-SB",
        },
        {
          config: "K2 + coupled K1-SB (behind, NC)",
          preset: "[K2 xxx] + [K1SB_100_NC]",
          acoustic: "reinforced LF contour, LF rejection(rear cardioid), down to 25 Hz",
          acousticShort: "rear cardioid, down to 25 Hz",
          ratio: "3 K2 : 2 subwoofers",
        },
        {
          config: "K2 + subwoofers (KS28/SB28)",
          preset: "[K2 xxx] + [xx28_60]",
          acoustic: "reinforced LF contour, down to 25 Hz",
          acousticShort: "reinforced contour, down to 25 Hz",
          ratio: "3 K2 : 2 subwoofers",
        },
        {
          config: "K2 + coupled CS1 (beside/behind)",
          preset: "[K2 xxx] + [CS1_60]",
          acoustic: "reinforced LF contour, LF rejection(rear cardioid), down to 25 Hz",
          acousticShort: "rear cardioid, down to 25 Hz",
          ratio: "3 K2 : 1 CS1",
        },
        {
          config: "K2 + coupled CS1 (supercardioid)",
          preset: "[K2 xxx] + [CS1_60_S]",
          acoustic: "reinforced LF contour, supercardioid pattern, down to 25 Hz",
          acousticShort: "supercardioid, down to 25 Hz",
          ratio: "3 K2 : 1 CS1",
        },
        {
          config: "K2 + Kara II (downfill)",
          preset: "[K2 xxx] + [KARAIIDOWNK2]",
          acoustic: "35 Hz - 20 kHz, extends vertical coverage to closer audience",
          acousticShort: "35 Hz - 20 kHz, downfill",
          ratio: "up to 6 Kara II",
        },
      ...
      delayDefaults: {
        rows: [
          ...
          {
            combo: "[K2 70]/[K2 90]/[K2 110] + [K1SB_X K2] + [KS28_60]",
            items: ["K2 = 0 ms", "K1-SB = 0 ms", "KS28 = 0 ms (−)"],
          },
          {
            combo: "[K2 70]/[K2 90]/[K2 110] + [K1SB_X K2] + [KS28_60_C]",
            items: ["K2 = 5.5 ms", "K1-SB = 5.5 ms", "KS28 = 0 ms (−)"],
          },
          {
            combo: "[K2 70]/[K2 90]/[K2 110] + [K1SB_X K2] + [KS28_60_Cx]",
            items: ["K2 = 3.5 ms", "K1-SB = 3.5 ms", "KS28 = 0 ms (−)"],
          },
          {
            combo: "[K2 70]/[K2 90]/[K2 110] + [K1SB_60] + [KS28_60]",
            items: ["K2 = 6 ms", "K1-SB = 0 ms", "KS28 = 6 ms (−)"],
          },
          {
            combo: "[K2 70]/[K2 90]/[K2 110] + [K1SB_60] + [KS28_60_C]",
            items: ["K2 = 6 ms", "K1-SB = 0 ms", "KS28 = 0.5 ms (−)"],
          },
          {
            combo: "[K2 70]/[K2 90]/[K2 110] + [K1SB_60] + [KS28_60_Cx]",
            items: ["K2 = 6 ms", "K1-SB = 0 ms", "KS28 = 4 ms (−)"],
          },
          { combo: "[K2 70]/[K2 90]/[K2 110] + [CS1_60] / [CS1_60_S]", items: ["K2 = 7.5 ms", "CS1 = 0 ms (−)"] },
          {
            combo: "[K2 70]/[K2 90]/[K2 110] + [K1SB_X K2] + [CS1_60] / [CS1_60_S]",
            items: ["K2 = 7.5 ms", "K1-SB = 7.5 ms", "CS1 = 0 ms (−)"],
          },
        ],
        notes: [
          {
  ...
  },
  {
    ...
    img: "public/assets/img/speakers/la/official/k-series/k3/01-3dr-k3-3-4-front-catalogue-01.jpg",
    views: [
      {
        label: "K3 3 4 Front Catalogue 01",
        src: "public/assets/img/speakers/la/official/k-series/k3/01-3dr-k3-3-4-front-catalogue-01.jpg",
      },
      {
        label: "12xK3+K3-BUMP+K3-BAR 01",
        src: "public/assets/img/speakers/la/official/k-series/k3/02-3dr-12xk3-k3-bump-k3-bar-01.jpg",
      },
      {
        label: "4xK3+2xKS28+K3-TILT 01",
        src: "public/assets/img/speakers/la/official/k-series/k3/03-3dr-4xk3-2xks28-k3-tilt-01.jpg",
      },
      {
        label: "8xK3+2xK3-RIGBAR 01",
        src: "public/assets/img/speakers/la/official/k-series/k3/04-3dr-8xk3-2xk3-rigbar-01.jpg",
      },
      {
        label: "4xK3+K3-CHARIOT+K3-CHARIOTCOV+K3-LID 01",
        src: "public/assets/img/speakers/la/official/k-series/k3/05-3dr-4xk3-k3-chariot-k3-chariotcov-k3-lid-01.jpg",
      },
    ],
    ...
    presets: {
      rows: [
        {
          config: "K3 line source",
          preset: "[K3 xxx]",
          acoustic: "42 Hz - 20 kHz, adjustable horizontal directivity",
          acousticShort: "42 Hz - 20 kHz, adjustable directivity",
        },
        {
          config: "K3 + subwoofers (KS28/KS21)",
          preset: "[K3 xxx] + [KSxx_60]",
          acoustic: "reinforced LF contour, down to 29 Hz (KS21) or 25 Hz (KS28)",
          acousticShort: "reinforced contour, down to 29/25 Hz",
          ratio: "2 K3 : 1 KS28 / 3 K3 : 2 KS21",
        },
        {
          config: "K3 + coupled CS1 (beside/behind)",
          preset: "[K3 xxx] + [CS1_60]",
          acoustic: "reinforced LF contour, LF rejection(rear cardioid), down to 25 Hz",
          acousticShort: "rear cardioid, down to 25 Hz",
        },
        {
          config: "K3 + coupled CS1 (supercardioid)",
          preset: "[K3 xxx] + [CS1_60_S]",
          acoustic: "reinforced LF contour, supercardioid pattern, down to 25 Hz",
          acousticShort: "supercardioid, down to 25 Hz",
        },
      ],
    ...
    mechanicalSafety: {
      flownRows: [{ config: "flown", accessory: "K3-BUMP", safeLimit: "16", maxLimit: "24" }],
      stackedRows: [
  ...
  },
  {
    ...
    img: "public/assets/img/speakers/la/official/k-series/k3i/02-3dr-k3i-perspective-01.jpg",
    views: [
      {
        label: "K3i Perspective 01",
        src: "public/assets/img/speakers/la/official/k-series/k3i/02-3dr-k3i-perspective-01.jpg",
      },
      {
        label: "K3i 3 4 Avant Catalogue 01",
        src: "public/assets/img/speakers/la/official/k-series/k3i/01-3dr-k3i-3-4-avant-catalogue-01.jpg",
      },
      {
        label: "8xK3i 70�+K3i-BUMP+K3i-BAR 01",
        src: "public/assets/img/speakers/la/official/k-series/k3i/03-3dr-8xk3i-70-k3i-bump-k3i-bar-01.jpg",
      },
      {
        label: "8xK3i+K3i-BUMP+K3i-SCREENS White RAL 01",
        src: "public/assets/img/speakers/la/official/k-series/k3i/04-3dr-8xk3i-k3i-bump-k3i-screens-white-ral-01.jpg",
      },
    ],
    ...
    notes:
      "K3의 설치용(install) 버전. 전용 인클로저로 K3와 치수/무게가 다름(K3i_AE_EN.docx 원문 확보, raw-data/raw-specs/la/speakers/k-series/k3i/k3i.md 참고).",
    relations: {
      ampIds: [],
    },
    watt: 830,
    ...
    presets: {
      rows: [
        {
          config: "K3i line source",
          preset: "[K3 xxx]",
          acoustic: "42 Hz - 20 kHz, adjustable horizontal directivity",
          acousticShort: "42 Hz - 20 kHz, adjustable directivity",
        },
        {
          config: "K3i + KS28 or KS21i",
          preset: "[K3 xxx] + [KSxx_60]",
          acoustic: "reinforced LF contour, down to 29 Hz (KS21i) or 25 Hz (KS28)",
          acousticShort: "reinforced contour, down to 29/25 Hz",
          ratio: "2 K3i : 1 KS28 / 3 K3i : 2 KS21i",
        },
        {
          config: "K3 + coupled CS1 (beside/behind)",
          preset: "[K3 xxx] + [CS1_60]",
        ...
        {
          config: "K3i + Kara IIi (downfill)",
          preset: "[K3 xxx] + [KARAIIDOWNK3]",
          acoustic: "42 Hz - 20 kHz, extends vertical coverage to closer audience",
          acousticShort: "42 Hz - 20 kHz, downfill",
        },
      ],
      notes: [
        {
  ...
  },
  {
    ...
    img: "public/assets/img/speakers/la/official/k-series/kara-ii/01-3dr-kara-ii-3-4-avant-catalogue-01.jpg",
    views: [
      {
        label: "Kara II 3 4 Avant Catalogue 01",
        src: "public/assets/img/speakers/la/official/k-series/kara-ii/01-3dr-kara-ii-3-4-avant-catalogue-01.jpg",
      },
      {
        label: "Kara II 3 4 Avant Catalogue 02",
        src: "public/assets/img/speakers/la/official/k-series/kara-ii/02-3dr-kara-ii-3-4-avant-catalogue-02.jpg",
      },
      {
        label: "12xKara II+M-Bump+M-Bar 01",
        src: "public/assets/img/speakers/la/official/k-series/kara-ii/03-3dr-12xkara-ii-m-bump-m-bar-01.jpg",
      },
      {
        label: "3xSB18+9xKARA II 01",
        src: "public/assets/img/speakers/la/official/k-series/kara-ii/04-3dr-3xsb18-9xkara-ii-01.jpg",
      },
    ],
    ...
    presets: {
      rows: [
        ...
        {
          config: "line source + coupled subwoofers (SB18/KS21)",
          preset: "[KARA II xxx] + [xxxx_100]",
          acoustic: "down to 32 Hz(SB18)/31 Hz(KS21)/25 Hz(KS28/SB28)",
          acousticShort: "down to 32/31/25 Hz",
          ratio: "3 Kara II : 1 SB18 or KS21",
          minLine: "9 Kara II + 3 SB18",
        },
        {
          config: "line source + separated subwoofers",
          preset: "[KARA II xxx] + [xxxx_60]",
          acoustic: "reinforced LF contour",
          acousticShort: "reinforced LF contour",
          ratio: "3 Kara II : 2 SB18 or KS21",
        },
        {
          config: "line source + coupled subwoofers + KS28/SB28",
          preset: "[KARA II xxx] + [xxxx_100] + [xxxx_60]",
          acoustic: "reinforced LF contour, high-pass at 100 Hz",
          acousticShort: "reinforced contour, HPF 100 Hz",
          ratio: "3 Kara II : 1 SB18 or KS21 : 1 KS28",
          minLine: "9 Kara II + 3 SB18",
        },
        {
          config: "single or pair of enclosures",
          preset: "[KARA II_FI]",
          acoustic: "flat response",
          acousticShort: "flat response",
        },
        {
          config: "single/pair + coupled subwoofers (SB18/KS21)",
          preset: "[KARA II_FI] + [xxxx_100]",
          acoustic: "down to 32 Hz(SB18) or 31 Hz(KS21), reinforced LF contour",
          acousticShort: "down to 32/31 Hz, reinforced contour",
        },
        {
          config: "up to three enclosures",
          preset: "[KARA II_MO]",
          acoustic: "55 Hz - 20 kHz, low latency",
          acousticShort: "55 Hz - 20 kHz, low latency",
        },
        {
          config: "up to three + coupled subwoofers",
          preset: "[KARA II_MO] + [xxxx_60]",
          acoustic: "down to 32 Hz(SB18) or 29 Hz(KS21), reinforced LF contour, low latency",
          acousticShort: "down to 32/29 Hz, low latency",
        },
      ],
      notes: [
        {
      ...
      delayDefaults: {
        rows: [
          ...
          {
            combo: "[KARA II] + [SB18_100] + [KS28_60]",
            items: ["Kara II = 0 ms", "SB18 = 0 ms", "KS28 = 5.5 ms (−)"],
          },
          {
            combo: "[KARA II] + [SB18_100] + [KS28_60_C]",
            items: ["Kara II = 0 ms", "SB18 = 0 ms", "KS28 = 0 ms (−)"],
          },
          {
            combo: "[KARA II] + [SB18_100] + [KS28_60_Cx]",
            items: ["Kara II = 5.5 ms", "SB18 = 5.5 ms", "KS28 = 0 ms"],
          },
          {
            combo: "[KARA II] + [KS21_100] + [KS28_60]",
            items: ["Kara II = 0 ms", "KS21 = 0 ms", "KS28 = 5.5 ms (−)"],
          },
          {
            combo: "[KARA II] + [KS21_100] + [KS28_60_C]",
            items: ["Kara II = 0 ms", "KS21 = 0.5 ms", "KS28 = 0 ms (−)"],
          },
  ...
  },
  {
    ...
    img: "public/assets/img/speakers/la/official/k-series/kara-iii/01-3dr-kara-iii-3-4-avant-catalogue-01.jpg",
    views: [
      {
        label: "Kara IIi 3 4 Avant Catalogue 01",
        src: "public/assets/img/speakers/la/official/k-series/kara-iii/01-3dr-kara-iii-3-4-avant-catalogue-01.jpg",
      },
      {
        label: "Kara IIi 3 4 Avant Catalogue Ailettes Fermees 01",
        src: "public/assets/img/speakers/la/official/k-series/kara-iii/02-3dr-kara-iii-3-4-avant-catalogue-ailettes-fermees-01.jpg",
      },
      {
        label: "3xSB18 IIi+9xKara IIi+KARAIIi-BUMP 01",
        src: "public/assets/img/speakers/la/official/k-series/kara-iii/03-3dr-3xsb18-iii-9xkara-iii-karaiii-bump-01.jpg",
      },
      {
        label: "8xKara IIi+KARAIIi-BUMP+M-BARi 01",
        src: "public/assets/img/speakers/la/official/k-series/kara-iii/04-3dr-8xkara-iii-karaiii-bump-m-bari-01.jpg",
      },
    ],
    ...
    notes:
      "Kara II의 설치용(install) 버전. 전용 인클로저로 Kara II와 치수/무게가 다름(Kara_IIi_AE_EN.docx 원문 확보, raw-data/raw-specs/la/speakers/k-series/kara-iii/kara-iii.md 참고). Depth 치수는 출처 간 미세 불일치(409mm vs 403mm)가 있어 docx 값을 채택했다(각주 참고).",
    relations: {
      ampIds: [],
    },
    watt: 355,
    ...
    presets: {
      ...
      delayDefaults: {
        rows: [
          ...
          {
            combo: "[Kara IIi] + [SB18 IIi_100] + [SB28_60]",
            items: ["Kara IIi = 0 ms", "SB18 IIi = 0 ms", "SB28 = 5.5 ms (−)"],
          },
          {
            combo: "[Kara IIi] + [SB18 IIi_100] + [SB28_60_C]",
            items: ["Kara IIi = 0 ms", "SB18 IIi = 0 ms", "SB28 = 0 ms (−)"],
          },
          {
            combo: "[Kara IIi] + [SB18 IIi_100] + [SB28_60_Cx]",
            items: ["Kara IIi = 5.5 ms", "SB18 IIi = 5.5 ms", "SB28 = 0 ms"],
          },
          {
            combo: "[Kara IIi] + [SB18 IIi_100] + [KS28_60]",
            items: ["Kara IIi = 0 ms", "SB18 IIi = 0 ms", "KS28 = 5.5 ms (−)"],
          },
          {
            combo: "[Kara IIi] + [SB18 IIi_100] + [KS28_60_C]",
            items: ["Kara IIi = 0 ms", "SB18 IIi = 0 ms", "KS28 = 0 ms (−)"],
          },
          {
            combo: "[Kara IIi] + [SB18 IIi_100] + [KS28_60_Cx]",
            items: ["Kara IIi = 5.5 ms", "SB18 IIi = 5.5 ms", "KS28 = 0 ms"],
          },
          {
            combo: "[Kara IIi] + [KS21i_100] + [SB28_60]",
            items: ["Kara IIi = 0 ms", "KS21i = 0.5 ms", "SB28 = 5.5 ms (−)"],
          },
          {
            combo: "[Kara IIi] + [KS21i_100] + [SB28_60_C]",
            items: ["Kara IIi = 0 ms", "KS21i = 0.5 ms", "SB28 = 0 ms (−)"],
          },
          {
            combo: "[Kara IIi] + [KS21i_100] + [SB28_60_Cx]",
            items: ["Kara IIi = 5.5 ms", "KS21i = 6 ms", "SB28 = 0 ms"],
          },
          {
            combo: "[Kara IIi] + [KS21i_100] + [KS28_60]",
            items: ["Kara IIi = 0 ms", "KS21i = 0 ms", "KS28 = 5.5 ms (−)"],
          },
          {
            combo: "[Kara IIi] + [KS21i_100] + [KS28_60_C]",
            items: ["Kara IIi = 0 ms", "KS21i = 0.5 ms", "KS28 = 0 ms (−)"],
          },
          {
            combo: "[Kara IIi] + [KS21i_100] + [KS28_60_Cx]",
            items: ["Kara IIi = 5.5 ms", "KS21i = 6 ms", "KS28 = 0 ms"],
          },
        ],
        notes: [
          {
    ...
    mechanicalSafety: {
      flownRows: [
        {
          config: "flown",
          accessory: "KARAIIi-BUMP + M-BARi (optional) + rigging plates",
          safeLimit: "12",
          maxLimit: "24",
        },
      ],
  ...
  },
  {
    ...
    cov: {
      h: "100°",
      splayList: [0, 1, 2, 3, 4, 5, 7.5, 10, 12.5, 15],
    },
    freqs: [
      {
        db: "-3 dB",
    ...
    img: "public/assets/img/speakers/la/official/k-series/kiva-ii/05-3dr-kiva-ii-perspective-01-800x400-1.png",
    views: [
      {
        label: "Kiva II Perspective",
        src: "public/assets/img/speakers/la/official/k-series/kiva-ii/05-3dr-kiva-ii-perspective-01-800x400-1.png",
      },
      {
        label: "Kiva II Array",
    ...
    presets: {
      rows: [
        ...
        {
          config: "line source + coupled subwoofer (SB15m/SB18)",
          preset: "[KIVA II] + [SB15_100] / [SB18_60]",
          acoustic: "down to 32 Hz(SB18)/40 Hz(SB15m), reinforced LF contour",
          acousticShort: "down to 32/40 Hz, reinforced contour",
          ratio: "3 Kiva II : 1 SB15m / 2 Kiva II : 1 SB15m",
          minLine: "12 Kiva II + 4 SB15m",
        },
        {
          config: "up to three enclosures",
          preset: "[KIVA II_FI]",
          acoustic: "70 Hz - 20 kHz, flat response",
          acousticShort: "70 Hz - 20 kHz, flat response",
        },
        {
          config: "up to three + coupled subwoofer (SB15m)",
          preset: "[KIVA II_FI] + [SB15_100]",
          acoustic: "down to 40 Hz, reinforced LF contour",
          acousticShort: "down to 40 Hz, reinforced contour",
          ratio: "3 Kiva II : 1 SB15m / 2 Kiva II : 1 SB15m",
        },
      ],
      notes: [
      ...
      delayDefaults: {
        rows: [
          ...
          {
            combo: "[KIVA II] + [SB15_100] + [SB18_60_C]",
            items: ["Kiva II = 4.5 ms", "SB15m = 5.5 ms", "SB18 = 0 ms (−)"],
          },
          {
            combo: "[KIVA II] + [SB15_100_C] + [SB18_60]",
            items: ["Kiva II = 2.5 ms", "SB15m = 0 ms", "SB18 = 3.5 ms (−)"],
          },
          {
            combo: "[KIVA II] + [SB15_100_C] + [SB18_60_C]",
            items: ["Kiva II = 4.5 ms", "SB15m = 2 ms", "SB18 = 0 ms (−)"],
          },
    ...
    mechanicalSafety: {
      ...
      stackedRows: [{ config: "ceiling-mounted", accessory: "KIET II", safeLimit: "—", maxLimit: "3" }],
      safetyFactor: "4:1",
      maxWindLoad: "6 Beaufort",
  ...
  },
  {
    ...
    ampRaw: "LA12X(1/4)",
    img: "public/assets/img/speakers/la/official/k-series/k1-sb/03-3dr-k1-sb-perspective-01.jpg",
    views: [
      {
        label: "K1-SB Perspective 01",
        src: "public/assets/img/speakers/la/official/k-series/k1-sb/03-3dr-k1-sb-perspective-01.jpg",
      },
      {
        label: "K1-SB 3 4 Avant Catalogue 01",
        src: "public/assets/img/speakers/la/official/k-series/k1-sb/02-3dr-k1-sb-3-4-avant-catalogue-01.jpg",
      },
      {
      ...
      },
      {
        ...
        src: "public/assets/img/speakers/la/official/k-series/k1-sb/04-3dr-8xk1-sb-k1-bump-01.jpg",
      },
    ],
    relations: {
      ampIds: [],
    ...
    mechanicalSafety: {
      ...
      flownRows: [
        ...
        {
          config: "flown, with LA-RAK II AVB",
          accessory: "K1-BUMP",
          safeLimit: "18 K1-SB + 3 LA-RAK II AVB",
          maxLimit: "24 K1-SB + 4 LA-RAK II AVB",
        },
      ],
