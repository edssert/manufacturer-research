export const BRANDS = [
  {
    ...
    timeline: [
      ...
      { year: 2012, event: "설치(Fixed Installation) 시장 진출 — 극장·아레나 전용 제품군 출시" },
      {
        year: 2014,
        event:
          "K2 출시(Prolight+Sound International Press Award 수상), Panflex 기술 공개, 직원 200명 돌파, 영국 지사 개설",
      },
  ...
  },
  {
    ...
    notable: [
      "F1/F2/B1 PA 시스템 (1985)",
      "J-Series 라인어레이",
      "GSL/KSL/XSL 라인어레이 3부작",
      "d&b Soundscape (DS100 + En-Scene/En-Space)",
      "R1 리모트 제어 소프트웨어 및 ArrayCalc 시뮬레이션",
    ],
    notes:
      "1981년 4월 18일 독일 Korb의 차고에서 Jürgen Daubert와 Rolf Belz가 창업(사명은 두 사람 이니셜에서 유래). 1989년 옛 방적공장 부지인 Backnang으로 이전해 지금까지 본사 겸 생산 거점으로 쓰고 있다. 1985년 F1/F2/B1으로 표준화된 완제품 PA 시스템을 출시하며 커스텀 제작 방식에서 벗어났고, 이후 J-Series(2006)·GSL/KSL/XSL 3부작(2018~2021)·d&b Soundscape(2017) 등으로 라이브·설치 시장을 선도했다. 소유권은 Odewald & Compagnie·Cobepa(2011~2016) → Ardian(2016~2023) → Providence Equity Partners(2023~현재)로 이어졌다. 공식 발표 기준 전 세계 800명 이상의 임직원과 80개국 이상의 유통 파트너를 두고 있으며, 2025년 9월 CEO 교체가 발표되어 2026년 1월 1일부로 Jaakko Kaivonen이 신임 CEO로 취임했다(전임 Amnon Harman은 감독이사회로 이동).",
    timeline: [
  ...
  },
  {
    ...
    founded: 1984,
    country: "Canada",
    hq: "Port Perry, Ontario",
    founder: "Brock Adamson",
    notable: [
      "Vergence Group VGt/VGx",
      "CS Series intelligent loudspeakers",
      "Kevlar transducer engineering",
      "ArrayIntelligence and Milan networked audio",
    ],
    notes:
      "Adamson Systems Engineering은 1984년 캐나다에서 시작한 프로 오디오 시스템 제조사다. Port Perry 본사에서 라우드스피커·전자장치·소프트웨어를 함께 개발하며, 현재 제품 체계는 Vergence Group, CS, M, IS, S, E Series를 포함한다. 이 카탈로그의 첫 검증 제품은 자체 앰프·DSP·Milan 네트워크를 통합한 VGt와 CS10이다.",
    timeline: [
      { year: 1984, event: "Brock Adamson이 캐나다에서 Adamson Systems Engineering 설립" },
      { year: 2024, event: "Vergence Group 첫 제품 VGt 공개" },
      { year: 2025, event: "VGt가 ISE Best of Show Award 수상" },
    ],
  },
  {
    id: "brand-co",
    ...
    founded: 2023,
    country: "United States",
    hq: "Lititz, Pennsylvania",
    founder: "Clair Global",
    notable: [
      "CO Series touring line arrays",
      "CF Series point sources",
      "CP218 II+ self-powered subwoofer",
      "Clair DSP system integration",
    ],
    notes:
      "Cohesion은 Clair Global Group의 프로 음향 제품 조직이다. Clair의 투어링 전용 자체 시스템에서 출발한 CO Series를 기반으로 2023년 제품 개발·제조 엔터프라이즈로 확대되었으며, 현재 line array, point source, subwoofer, amplifier, software와 accessory 생태계를 제공한다. 따라서 이 앱에서는 회사명 Clair가 아니라 공식 제품 브랜드명 Cohesion으로 분류한다.",
    timeline: [
      { year: 2012, event: "CO8의 전신 iMicro가 Clair 투어링 시스템으로 도입" },
      { year: 2015, event: "CO12 첫 배치" },
      { year: 2018, event: "CO10 도입" },
      { year: 2023, event: "Clair Global이 Cohesion을 독립 제품 개발·제조 조직으로 확대" },
      { year: 2024, event: "CF Series 포인트소스 전체 라인업 공개" },
    ],
  },
];
