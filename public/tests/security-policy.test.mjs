...
assert(
  scripts.every(([, attributes, body]) => /\bsrc="[^"]+"/.test(attributes) && body.trim() === ""),
  "인라인 스크립트는 CSP에서 허용하지 않습니다.",
);
assert(
  index.indexOf("public/js/bootstrap-preferences.js") < index.indexOf("public/css/tokens.css"),
  "표시 선호 bootstrap은 CSS보다 먼저 로드해야 합니다.",
);
